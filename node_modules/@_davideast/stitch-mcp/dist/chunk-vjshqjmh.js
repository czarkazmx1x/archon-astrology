  ...
  async execute(input) {
    ...
    try {
      switch (input.command) {
        case "init": {
          const { InitHandler } = await import("./chunk-5f2htt6r.js");
        ...
        case "doctor": {
          const { DoctorHandler } = await import("./chunk-26cgk4dt.js");
        ...
        case "site": {
          const { SiteBuilder } = await import("./chunk-44tn9dxb.js");
          ...
          try {
            const { render } = await import("./chunk-gwnmywrp.js");
