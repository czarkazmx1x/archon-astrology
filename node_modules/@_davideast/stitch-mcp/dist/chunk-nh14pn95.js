...
class ViewCommandHandler {
  ...
  async executeServeMode(options) {
    ...
    const { ViewHandler } = await import("./chunk-xhad5b8x.js");
    ...
    const { StitchViteServer } = await import("./chunk-c5dtqvff.js");
  ...
  async executeInteractiveMode(options) {
    const { render } = await import("./chunk-8w97w2wa.js");
    const React = await import("./chunk-k86st2r8.js");
    const { InteractiveViewer } = await import("./chunk-gcx3c3yc.js");
    const { ViewHandler } = await import("./chunk-xhad5b8x.js");
    const handler = new ViewHandler;
