...
if (process3.env["DEV"] === "true") {
  try {
    await import("./chunk-rp8wjzht.js");
  } catch (error) {
...
class Ink {
  ...
  constructor(options) {
    ...
    this.isScreenReaderEnabled = options.isScreenReaderEnabled ?? process10.env["INK_SCREEN_READER"] === "true";
...
function Newline({ count = 1 }) {
  return import_react16.default.createElement("ink-text", null, `
`.repeat(count));
}
// node_modules/ink/build/components/Spacer.js
var import_react17 = __toESM(require_react(), 1);
function Spacer() {
  return import_react17.default.createElement(Box_default, { flexGrow: 1 });
}
...
var useStderr = () => import_react22.useContext(StderrContext_default);
...
var useFocus = ({ isActive = true, autoFocus = false, id: customId } = {}) => {
  ...
  const { activeId, add, remove, activate, deactivate, focus } = import_react23.useContext(FocusContext_default);
  const id = import_react23.useMemo(() => {
...
var useFocusManager = () => {
  const focusContext = import_react24.useContext(FocusContext_default);
  return {
...
var useIsScreenReaderEnabled = () => {
  const { isScreenReaderEnabled } = import_react25.useContext(accessibilityContext);
...
export { Box_default, Text, render_default, Static, Transform, Newline, Spacer, use_stdin_default, use_input_default, use_app_default, use_stdout_default, use_stderr_default, use_focus_default, use_focus_manager_default, use_is_screen_reader_enabled_default, measure_element_default };

//# debugId=369A67D5727423DB64756E2164756E21
