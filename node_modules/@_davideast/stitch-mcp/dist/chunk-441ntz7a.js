...
class ViewCommandHandler {
  ...
  async executeServeMode(options) {
    ...
    const { ViewHandler } = await import("./chunk-j1v44zzm.js");
    ...
    const { StitchViteServer } = await import("./chunk-f5wqd3z3.js");
  ...
  async executeInteractiveMode(options) {
    const { render } = await import("./chunk-xtcg74kf.js");
    const React = await import("./chunk-94xqpnv4.js");
    const { InteractiveViewer } = await import("./chunk-f0dt9hv8.js");
    const { ViewHandler } = await import("./chunk-j1v44zzm.js");
    const handler = new ViewHandler;
