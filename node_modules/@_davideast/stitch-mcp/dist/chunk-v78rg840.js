...
class ViewCommandHandler {
  ...
  async executeServeMode(options) {
    ...
    const { ViewHandler } = await import("./chunk-rfrcdsfc.js");
    ...
    const { StitchViteServer } = await import("./chunk-j0y94q2c.js");
  ...
  async executeInteractiveMode(options) {
    ...
    const { InteractiveViewer } = await import("./chunk-dffwrtn3.js");
    const { ViewHandler } = await import("./chunk-rfrcdsfc.js");
    const handler = new ViewHandler;
